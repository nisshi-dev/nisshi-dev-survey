...
describe("buildResponseEmailHtml", () => {
  ...
  test("質問番号 (Q1, Q2...) を正確に付与する", () => {
    ...
    const html = buildResponseEmailHtml("アンケート", questions, answers);
