...
vi.mock("@/generated/api/admin-surveys/admin-surveys", () => ({
  useGetAdminSurveysById: vi.fn(),
  useGetAdminSurveysByIdResponses: vi.fn(),
  usePatchAdminSurveysById: vi.fn(),
  useDeleteAdminSurveysById: vi.fn(),
  usePostAdminSurveysByIdDataEntries: vi.fn(),
  usePutAdminSurveysByIdDataEntriesByEntryId: vi.fn(),
  useDeleteAdminSurveysByIdDataEntriesByEntryId: vi.fn(),
}));
...
const mockUseSurvey = vi.mocked(useGetAdminSurveysById);
const mockUseResponses = vi.mocked(useGetAdminSurveysByIdResponses);
const mockUsePatch = vi.mocked(usePatchAdminSurveysById);
const mockUseDelete = vi.mocked(useDeleteAdminSurveysById);
const mockUseCreateEntry = vi.mocked(usePostAdminSurveysByIdDataEntries);
